...
class SongsFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        playListRepository = PlayListRepository(requireActivity(),AudioPlayerDB.getDatabase(requireActivity()))
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        playListViewModel = ViewModelProvider(this, PlaylistFactory(playListRepository!!)).get(PlayListViewModel::class.java)
