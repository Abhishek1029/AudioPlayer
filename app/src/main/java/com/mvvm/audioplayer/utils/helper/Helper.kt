...
import com.mvvm.audioplayer.roomdb.CreatePlaylistEntity
...
class Helper {
    companion object {
        ...
        fun insert_Playlist(activity: Activity, model: SongsModel) {
            ...
            val createPlaylist = dialogView.findViewById<TextView>(R.id.crate_playlits_button)
            val editTitle = dialogView.findViewById<EditText>(R.id.edit_title)
            createPlaylist.setOnClickListener {
/*                val playlistEntity = CreatePlaylistEntity(model.songId)
